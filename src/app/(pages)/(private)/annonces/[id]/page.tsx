            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-2/3 flex flex-col gap-8">
                    ...
                    <div className="rounded-xl">
                        ...
                        <div className="flex overflow-x-auto gap-4 sm:grid sm:grid-cols-2 xl:grid-cols-3 sm:overflow-x-visible">
                            {similaires.map((annonce) => (
                                <div className="min-w-[280px] flex-shrink-0 sm:min-w-0">
