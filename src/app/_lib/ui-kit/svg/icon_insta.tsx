...
export default function InstaIcon({width, height}: RsProps): JSX.Element {
    return <svg fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width={width} height={height}>
        <path
