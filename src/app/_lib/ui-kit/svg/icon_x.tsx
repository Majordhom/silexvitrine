...
export default function XIcon({width, height}: RsProps): JSX.Element {
    return <svg fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={width} height={height}>
        <path
